...
import { AUG, DEC, FEB, JAN, JUL, JUN, MAR, MAY, NOV, OCT, SEP } from '@angular/material/core';
    ...
    describe('a11y', () => {
      describe('calendar body', () => {
        ...
        beforeEach(() => {
          ...
          calendarBodyEl = fixture.debugElement.nativeElement.querySelector('.mat-calendar-body') as HTMLElement;
