...
import { DEC, JAN, JUL, JUN, SEP } from '@angular/material/core';
...
describe('MatDatepicker', () => {
  ...
  describe('with MatNativeDateModule', () => {
    describe('standard datepicker', () => {
      ...
      it('open touch should open dialog', () => {
        ...
        expect(document.querySelector('.mat-datepicker-dialog mat-dialog-container')).not.toBeNull();
      });

      it(
        'should open datepicker if opened input is set to true',
        fakeAsync(() => {
      ...
      it(
        ...
        fakeAsync(() => {
          ...
          expect(parseInt(getComputedStyle(popup).height as string, 10)).not.toBe(0);
      ...
      it(
        'should close the popup when pressing ESCAPE',
        fakeAsync(() => {
          testComponent.datepicker.open();
          fixture.detectChanges();
      ...
      it(
        'setting selected via click should update input and close calendar',
        fakeAsync(() => {
          testComponent.touch = true;
          fixture.detectChanges();
      ...
      it(
        'setting selected via enter press should update input and close calendar',
        fakeAsync(() => {
          testComponent.touch = true;
          fixture.detectChanges();
      ...
      it(
        'pressing enter on the currently selected date should close the calendar without ' + 'firing selectedChanged',
        () => {
          const selectedChangedSpy = spyOn(testComponent.datepicker._selectedChanged, 'next').and.callThrough();
      ...
      it(
        'input should aria-owns calendar after opened in non-touch mode',
        fakeAsync(() => {
      ...
      it(
        'should clear out the backdrop subscriptions on close',
        fakeAsync(() => {
          for (let i = 0; i < 3; i++) {
            testComponent.datepicker.open();
            fixture.detectChanges();
      ...
      it(
        'should reset the datepicker when it is closed externally',
        fakeAsync(
      ...
      it(
        'should close the datpeicker using ALT + UP_ARROW',
        fakeAsync(() => {
          testComponent.datepicker.open();
          fixture.detectChanges();
          flush();
    ...
    describe('datepicker with too many inputs', () => {
      it(
        'should throw when multiple inputs registered',
        fakeAsync(() => {
    ...
    describe('datepicker with no inputs', () => {
      ...
      it(
        'should throw when opened with no registered inputs',
        fakeAsync(() => {
    ...
    describe('datepicker with startView set to year', () => {
      ...
      it('should start at the specified view', () => {
        ...
        // for a date.
        expect(firstCalendarCell.textContent).toBe('JAN', 'Expected the calendar to be in year-view');
      });

      it(
        'should fire yearSelected when user selects calendar year in year view',
        fakeAsync(() => {
    ...
    describe('datepicker with startView set to multiyear', () => {
      ...
      it('should start at the specified view', () => {
        ...
        // When the calendar is in year view, the first cell should be for a month rather than
        // for a date.
        expect(firstCalendarCell.textContent).toBe('2016', 'Expected the calendar to be in multi-year-view');
      });

      it(
        'should fire yearSelected when user selects calendar year in multiyear view',
        fakeAsync(() => {
    ...
    describe('datepicker with ngModel', () => {
      ...
      it(
        'should update datepicker when model changes',
        fakeAsync(() => {
      ...
      it(
        'should update model when date is selected',
        fakeAsync(() => {
      ...
      it(
        'should mark input dirty after date selected',
        fakeAsync(() => {
          let inputEl = fixture.debugElement.query(By.css('input')).nativeElement;
      ...
      it(
        'should not mark dirty after model change',
        fakeAsync(() => {
          let inputEl = fixture.debugElement.query(By.css('input')).nativeElement;
      ...
      it(
        'should mark input touched on calendar selection',
        fakeAsync(() => {
          let inputEl = fixture.debugElement.query(By.css('input')).nativeElement;
    ...
    describe('datepicker with mat-datepicker-toggle', () => {
      ...
      it(
        'should toggle the active state of the datepicker toggle',
        fakeAsync(() => {
    ...
    describe('datepicker with custom mat-datepicker-toggle icon', () => {
      it(
        'should be able to override the mat-datepicker-toggle icon',
        fakeAsync(() => {
          const fixture = createComponent(DatepickerWithCustomIcon, [MatNativeDateModule]);
          fixture.detectChanges();

          expect(fixture.nativeElement.querySelector('.mat-datepicker-toggle .custom-icon')).toBeTruthy(
            'Expected custom icon to be rendered.'
          );

          expect(fixture.nativeElement.querySelector('.mat-datepicker-toggle mat-icon')).toBeFalsy(
    ...
    describe('datepicker inside mat-form-field', () => {
      ...
      it(
        'should pass the form field theme color to the overlay',
        fakeAsync(() => {
    ...
    describe('datepicker with min and max dates and validation', () => {
      ...
      it(
        'should mark invalid when value is before min',
        fakeAsync(() => {
      ...
      it(
        'should mark invalid when value is after max',
        fakeAsync(() => {
      ...
      it(
        'should not mark invalid when value equals min',
        fakeAsync(() => {
      ...
      it(
        'should not mark invalid when value equals max',
        fakeAsync(() => {
      ...
      it(
        'should not mark invalid when value is between min and max',
        fakeAsync(() => {
    ...
    describe('datepicker with change and input events', () => {
      ...
      it(
        'should fire dateChange and dateInput events when user selects calendar date',
        fakeAsync(() => {
          expect(testComponent.onChange).not.toHaveBeenCalled();
          expect(testComponent.onDateChange).not.toHaveBeenCalled();
          expect(testComponent.onInput).not.toHaveBeenCalled();
    ...
    describe('with events', () => {
      ...
      it(
        'should dispatch an event when a datepicker is closed',
        fakeAsync(() => {
          testComponent.datepicker.open();
          fixture.detectChanges();
    ...
    describe('datepicker that opens on focus', () => {
      ...
      it(
        'should not reopen if the browser fires the focus event asynchronously',
        fakeAsync(() => {
    ...
    describe('datepicker directionality', () => {
      ...
      it(
        'should update the popup direction if the directionality value changes',
        fakeAsync(() => {
  ...
  describe('with missing DateAdapter and MAT_DATE_FORMATS', () => {
    it('should throw when created', () => {
      expect(() => createComponent(StandardDatepicker)).toThrowError(/MatDatepicker: No provider found for .*/);
    });
  });
  ...
  describe('internationalization', () => {
    ...
    it(
      'should have the correct input value even when inverted date format',
      fakeAsync(() => {
  ...
  describe('datepicker with custom header', () => {
    ...
    beforeEach(
      fakeAsync(() => {
        fixture = createComponent(DatepickerWithCustomHeader, [MatNativeDateModule], [], [CustomHeaderForDatepicker]);
        fixture.detectChanges();
        testComponent = fixture.componentInstance;
      })
    );
    ...
    it(
      'should find the standard header element',
      fakeAsync(() => {
        testComponent.datepicker.open();
        fixture.detectChanges();
        flush();
